...
const Header = ({ isMobileMenuOpen, setIsMobileMenuOpen }: HeaderProps) => {
  ...
  return (
    <header className="md:absolute md:top-0 md:left-0 md:right-0 md:z-30 md:p-4 md:sm:p-6">
      ...
      <div className="md:hidden bg-primary border-b border-slate-700 relative z-30">
          ...
          <div className="w-full flex justify-between items-center">
            ...
            <div className="relative z-[100]" ref={dropdownRef}>
              <button
                ...
                className="flex items-center space-x-2 text-white text-sm hover:text-secondary transition-colors bg-white bg-opacity-10 px-3 py-2 rounded-lg min-h-[44px] active:scale-95 active:bg-opacity-30 cursor-pointer"
              >
                <Globe size={16} />
              ...
              {isDropdownOpen && (
                <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg overflow-hidden z-[100]">
                  <button
                    ...
                    language === 'en' ? 'bg-gray-100 text-secondary' : 'text-gray-700'
                  }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full flex items-center space-x-3 px-4 py-3 text-left hover:bg-gray-100 transition-colors cursor-pointer ${
                    language === 'am' ? 'bg-gray-100 text-secondary' : 'text-gray-700'
                  }`}
                  >
                    <span className="text-lg flex items-center">🇪🇹</span>
                    <div className="flex items-center">
            ...
            <button
              ...
              className="bg-secondary text-primary p-3 rounded-lg shadow-lg hover:bg-opacity-90 transition-all duration-300 min-w-[44px] min-h-[44px] flex items-center justify-center"
            >
            ...
            <div className="flex justify-center space-x-3">
              ...
              >
                <svg width={20} height={20} viewBox="0 0 24 24" fill="#EAAB21">
                  <rect x="2" y="2" width="20" height="20" rx="5" ry="5" fill="#EAAB21"/>
              ...
              >
                <svg width={20} height={20} viewBox="0 0 24 24" fill="#EAAB21">
                  <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" fill="#EAAB21"/>
                </svg>
              </a>
            ...
            <div className="relative w-[90%] mb-4">
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-white bg-opacity-10 backdrop-blur-md border border-white border-opacity-30 rounded-lg pl-10 pr-12 py-3 text-white placeholder-gray-300 focus:outline-none focus:border-secondary transition-colors min-h-[48px]"
                />
                ...
                <div 
                  className="absolute right-0 top-0 w-8 h-full bg-secondary rounded-r-lg"
                  style={{
      ...
      <div className="hidden md:flex justify-between items-start">
        ...
        <div className="flex flex-col items-start space-y-6">
          ...
          <div className="relative z-50" ref={dropdownRef}>
            <button
              ...
              className="flex items-center space-x-2 text-white text-sm hover:text-secondary transition-colors bg-white bg-opacity-10 px-3 py-2 rounded-lg backdrop-blur-sm min-h-[44px] active:scale-95 active:bg-opacity-30 cursor-pointer"
            >
              <Globe size={16} />
        ...
        <div className="flex flex-col items-end space-y-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              <svg width={18} height={18} className="sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="#EAAB21">
                <rect x="2" y="2" width="20" height="20" rx="5" ry="5" fill="#EAAB21"/>
                <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" fill="white"/>
                <line x1="17.5" y1="6.5" x2="17.51" y2="6.5" stroke="white" strokeWidth="2"/>
              </svg>
          ...
          <div className="relative">
            <div className="relative">
              <input 
                type="text" 
                placeholder="www.almaconprime.org"
                className="bg-white bg-opacity-20 backdrop-blur-md border border-white border-opacity-30 rounded-lg pl-10 pr-12 py-3 text-white placeholder-gray-300 focus:outline-none focus:border-secondary transition-colors min-h-[48px] h-12 w-64"
              />
              {/* Search icon inside the bar on the left */}
              <Search 
                size={16} 
