    ...
    <div className="bg-primary">
      ...
      <div className="px-4 sm:px-6 md:px-8 lg:px-16 py-12 md:py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-8">
            <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-4 sm:p-6 md:p-8 border border-secondary border-opacity-30 hover:bg-opacity-20 transition duration-300 flex flex-col h-full">
              <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 sm:mb-6 bg-secondary rounded-full flex items-center justify-center">
              ...
              <div className="text-center mb-4">
                <span className="inline-block px-3 py-2 bg-secondary text-primary text-sm font-bold rounded-full">
              ...
              <div className="text-center">
                <Link 
                  ...
                  className="inline-flex items-center text-secondary hover:text-white transition duration-300 py-2 px-4 rounded-lg hover:bg-white hover:bg-opacity-10 min-h-[44px]"
                >
      ...
      <section className="py-12 md:py-20 px-4 sm:px-6 md:px-8 lg:px-16 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-8">
            <div className="bg-gray-50 p-4 sm:p-6 md:p-8 rounded-lg shadow-lg border-l-4 border-secondary hover:shadow-xl transition duration-300">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-secondary rounded-full flex items-center justify-center mb-4 sm:mb-6">
              ...
              <Link 
                to="/services/building-construction"
                className="inline-flex items-center text-secondary hover:text-primary font-semibold transition duration-300 py-2 px-4 rounded-lg hover:bg-gray-100 min-h-[44px]"
              >
      ...
      {/* About Section */}
      <section className="py-20 px-16 bg-primary">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-8 mb-8 md:mb-12">
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-xl shadow-lg border-l-4 border-secondary">
              <h3 className="text-xl sm:text-2xl font-bold text-primary mb-4">
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-6">
              <div className="text-center">
                <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-2 sm:mb-3 bg-secondary rounded-full flex items-center justify-center">
          ...
          <div className="text-center">
            <Link 
              to="/about" 
              className="btn-secondary inline-flex items-center px-6 py-3 sm:px-8 sm:py-4 min-h-[44px]"
            >
              {t('about.readMore')}
      ...
      <section className="py-12 md:py-20 px-4 sm:px-6 md:px-8 lg:px-16 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="w-16 sm:w-24 h-1 bg-secondary mx-auto mb-8 md:mb-12"></div>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-8">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="border-b-4 border-secondary-400"></div>
              <div className="p-6 text-center">
                <p className="text-gray-700 italic mb-4 font-serif">
                  "{t('testimonials.client1.text')}"
                </p>
                <h4 className="font-bold text-primary text-lg">{t('testimonials.client1.name')}</h4>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="p-6 text-center">
                ...
                <h4 className="font-bold text-primary text-lg">{t('testimonials.client2.name')}</h4>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="p-6 text-center">
                ...
                <h4 className="font-bold text-primary text-lg">{t('testimonials.client3.name')}</h4>
          ...
          <div className="text-center mt-12">
            <Link 
              to="/testimonials" 
              className="btn-secondary inline-flex items-center px-6 py-3 sm:px-8 sm:py-3 min-h-[44px]"
            >
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  >
                    <svg width={20} height={20} viewBox="0 0 24 24" fill="#EAAB21">
                      ...
                      <rect x="2" y="9" width="4" height="12" fill="#EAAB21"/>
                      <circle cx="4" cy="4" r="2" fill="#EAAB21"/>
                    </svg>
                  </a>
                  <a 
          ...
          <div className="mt-12">
            ...
            <div className="relative rounded-xl overflow-hidden shadow-2xl">
              <iframe
                ...
                className="w-full"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-primary-800 to-transparent opacity-30 pointer-events-none"></div>
            </div>
          </div>
        </div>
      </section>
