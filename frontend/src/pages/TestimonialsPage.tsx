              ...
              <div className="relative">
                {testimonial.image ? (
                  <img 
                    ...
                    className="w-full h-48 object-cover object-top border-b-4 border-secondary"
                    onError={(e) => {
                      e.currentTarget.src = '';
                      e.currentTarget.className = 'w-full h-48 bg-gray-400 border-b-4 border-secondary flex items-center justify-center';
                  ...
                  <div className="w-full h-48 bg-gray-400 border-b-4 border-secondary flex items-center justify-center">
