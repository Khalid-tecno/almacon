      ...
      <div className="min-h-screen bg-deep-teal flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            ...
            className="inline-block bg-golden-yellow text-deep-teal px-6 py-3 rounded-lg font-semibold hover:bg-opacity-90 transition-colors cursor-pointer"
            type="button"
          >
    ...
    <div className="min-h-screen bg-deep-teal pt-20 pb-16">
      <div className="container mx-auto px-8">
        ...
        <button
          ...
          className="mb-8 inline-flex items-center bg-golden-yellow text-deep-teal px-6 py-3 rounded-lg font-semibold hover:bg-opacity-90 transition-colors relative z-50 cursor-pointer"
          type="button"
        >
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-1/2">
              <div className="mb-6">
                ...
                <p className="text-xl text-golden-yellow font-medium mb-6">{project.category}</p>
              </div>
              ...
              <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-6 mb-8">
                ...
                <div className="space-y-4">
                  {project.client && (
                    <div>
                      <h3 className="text-golden-yellow font-medium mb-1">{t('portfolioDetail.client')}</h3>
                  ...
                  {project.location && (
                    <div>
                      <h3 className="text-golden-yellow font-medium mb-1">{t('portfolioDetail.location')}</h3>
                  ...
                  {project.contractValue && (
                    <div>
                      <h3 className="text-golden-yellow font-medium mb-1">{t('portfolioDetail.contractValue')}</h3>
                  ...
                  {project.contractPeriod && (
                    <div>
                      <h3 className="text-golden-yellow font-medium mb-1">{t('portfolioDetail.contractPeriod')}</h3>
                  ...
                  {project.completionYear && (
                    <div>
                      <h3 className="text-golden-yellow font-medium mb-1">{t('portfolioDetail.completionYear')}</h3>
