      ...
      <div className="container mx-auto px-8">
        ...
        <div className="text-center mb-20">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-2xl font-semibold text-golden-yellow mb-4">{t('about.slogan')}</p>
        ...
        <div className="max-w-6xl mx-auto mb-20">
          <div className="bg-white bg-opacity-10 rounded-lg p-10">
            <h2 className="text-4xl font-bold text-golden-yellow mb-6 text-center">{t('about.ourStory')}</h2>
        ...
        <div className="max-w-6xl mx-auto mb-20">
          <div className="bg-white bg-opacity-10 rounded-lg p-10">
            <h2 className="text-4xl font-bold text-golden-yellow mb-6 text-center">{t('about.ultimatePurpose')}</h2>
            <p className="text-gray-300 leading-relaxed text-lg text-center max-w-4xl mx-auto">
        ...
        <div className="max-w-6xl mx-auto mb-20">
          <div className="bg-white bg-opacity-10 rounded-lg p-10">
            <h2 className="text-4xl font-bold text-golden-yellow mb-6 text-center">{t('about.brandIdentity')}</h2>
            <p className="text-gray-300 leading-relaxed text-lg text-center max-w-4xl mx-auto">
        ...
        <div className="max-w-6xl mx-auto mb-20">
          <h2 className="text-4xl font-bold text-golden-yellow mb-10 text-center">{t('about.businessSectors')}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white bg-opacity-10 rounded-lg p-8 text-center">
              <h3 className="text-2xl font-semibold text-golden-yellow mb-4">{t('about.sectors.construction')}</h3>
              <p className="text-gray-300 leading-relaxed">
                {t('about.sectors.construction.desc')}
              </p>
            </div>
            <div className="bg-white bg-opacity-10 rounded-lg p-8 text-center">
              <h3 className="text-2xl font-semibold text-golden-yellow mb-4">{t('about.sectors.realEstate')}</h3>
              <p className="text-gray-300 leading-relaxed">
                {t('about.sectors.realEstate.desc')}
              </p>
            </div>
            <div className="bg-white bg-opacity-10 rounded-lg p-8 text-center">
              <h3 className="text-2xl font-semibold text-golden-yellow mb-4">{t('about.sectors.materialSupply')}</h3>
              <p className="text-gray-300 leading-relaxed">
        ...
        <div className="max-w-6xl mx-auto mb-20">
          <h2 className="text-4xl font-bold text-golden-yellow mb-16 text-center">{t('about.employeeVoices')}</h2>
            ...
            {employeeVoices.map((employee, index) => (
              <div key={index} className="bg-white bg-opacity-10 rounded-lg overflow-hidden h-full flex flex-col">
                ...
                <div className="relative">
                  {employee.image ? (
                    <img 
                      src={employee.image} 
                      alt={employee.name}
                      className="w-full h-80 object-cover object-top border-b-4 border-golden-yellow"
                      onError={(e) => {
                        e.currentTarget.src = '';
                        e.currentTarget.className = 'w-full h-80 bg-gray-400 border-b-4 border-golden-yellow flex items-center justify-center';
                    ...
                    <div className="w-full h-80 bg-gray-400 border-b-4 border-golden-yellow flex items-center justify-center">
                ...
                <div className="p-6 flex-grow flex flex-col justify-center text-center">
                  ...
                  <div className="text-golden-yellow text-4xl font-serif opacity-20 mb-3 leading-none">"</div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white bg-opacity-10 rounded-lg p-8">
            <h2 className="text-3xl font-semibold text-golden-yellow mb-6 text-center">{t('about.coreValues')}</h2>
